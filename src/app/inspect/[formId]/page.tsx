      ...
      Object.fromEntries(
        fields.map((field) => {
          if (field.type === "number") {
            ...
            const numberSchema = z.preprocess((value) => (value === "" ? undefined : value), field.required ? numericSchema : numericSchema.optional());
          ...
          const textSchema = z.preprocess((value) => (value === "" ? undefined : value), field.required ? stringSchema : stringSchema.optional());
